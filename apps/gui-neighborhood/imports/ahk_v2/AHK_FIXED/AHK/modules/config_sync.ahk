...
; Also syncs clipboard data from the local FastAPI Data folder.
; ============================================================
...
; Clipboard data files used by sync_server.py.
global SYNC_CLIP_FILES := ["clipboard.db", "window_state.json"]
