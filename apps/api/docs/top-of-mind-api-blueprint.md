...
| Numbering | ports, sources, message types, priorities, walls, folders | `docs/numbering/README.md` |
...
- `GET /files/cache`
- `POST /files/cache`
- `GET /files/cache/search`
- `GET /files/cache/by-path`
...
3. Run the API on LAN, for example `http://192.168.2.50:10000`.
